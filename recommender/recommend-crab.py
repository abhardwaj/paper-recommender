...
def main():	
	...
	print matrix_model.preferences_from_user('pn1460')
	...
	#recommender = MatrixFactorBasedRecommender(matrix_model, items_selection_strategy=items_strategy, n_features=2, with_preference=True)
	print recommender.recommend('pn1460', how_many=10)
